...
router.put("/approve/:id", verify, async (req, res) => {
  if (req.user.isAdmin) {
    try {
      ...
      const message = `<h3>Congratulations ${student.name}.</h3><h4>You have been successfully enrolled for ${student.course}. Your payment of rupees ${student.fee} is successful. Enrollment ID is:${student.studentid}</h4><br><h4>Regards,</h4><br><h3>Team ICTAK</h3>   `;
